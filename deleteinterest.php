...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Διαγραφή ενδιαφέροντος</title>
        <!-- Meta -->
                    ...
                    <div class="row margin-vert-30">
                        ...
                        <div class="col-md-9">
							...
							<?php
								...
								$int_id = $_GET["id"];
								$conn = Connect();
								// Διαγραφή δραστηριότητας με το επιλεγμένο id
								$strSQL = "DELETE FROM user_prefs WHERE usr_id=$usr_id AND sub_cat_id=$int_id";
