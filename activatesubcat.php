...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Απενεργοποίηση υποκατηγορίας</title>
        <!-- Meta -->
                ...
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        ...
                        <div class="col-md-9">
                            <!-- Main Content -->
                            <div class="headline">
                                <h2>Απενεργοποίηση υποκατηγορίας</h2>
                            </div>
							<?php
								// Δέχεται σαν παράμετρο το cat_id (ID της κατηγορίας δραστηριότητας)
								// και το usr_id (ID του χρήστη)
								$subcat_id = $_GET["id"];
								$action_id = $_GET["action"];
								$conn = Connect();
								// 
								$strSQL = "UPDATE sub_categories SET scat_active=$action_id WHERE scat_id=$subcat_id";
								...
								if (!$result )
									...
									header("Location: subcategorieslist.php");
							?>
                        </div>
                        <!-- End Side Column -->
                    </div>
