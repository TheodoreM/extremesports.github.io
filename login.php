...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Συνδεθείτε στο EXTREME Sports</title>
        <!-- Meta -->
                ...
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        ...
                        <div class="col-md-9">
                            <!-- Main Content -->
                            <div class="headline">
                                <h2>Συνδεθείτε στο EXTREMESports</h2>
                            </div>
                            <p>
                                </p>
                            <br>
                            ...
                            <form method="POST">
                                ...
                                <p>
                                    <button type="submit" name="Submit" value="Σύνδεση" class="btn btn-primary">Σύνδεση</button>
									<button type="submit" name="Register" value="Εγγραφή" class="btn btn-primary">Εγγραφή</button>
                                </p>
							...
							<?php
								if (isset($_POST['Submit']))
								{
									...
									if (GetLoggedID() != 0)
										...
										echo "Τα στοιχεία εισόδου που δώσατε δεν είναι σωστά";
								}
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Επερχόμενες Δρατηριότητες</h3>
                                </div>
