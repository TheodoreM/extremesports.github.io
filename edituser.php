                ...
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        ...
                        <div class="col-md-9">
							...
							<?php
								// Δέχεται σαν παράμετρο το id (ID του χρήστη)
								$usr_id = $_GET["id"];
								if ($usr_id != GetLoggedID())
								{
									echo "Μπορείτε να επεξεργαστείτε μόνο τα δικά σας στοιχεία.";
									die();
								}
								$conn = Connect();
							...
							<?php 
								if (isset ($_POST['Submit']))
								{
									...
									if ($result)
									{
										echo "<br><p class='errortext'>Τα στοιχεία του προφίλ σας καταχωρήθηκαν.</br>";
