...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Καταχωρημένες υποκατηγορίες ανά κατηγορία</title>
        <!-- Meta -->
                ...
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        ...
                        <div class="col-md-9">
                            <!-- Main Content -->
                            <div class="headline">
                                <h2>Καταχωρημένες υποκατηγορίες δραστηριοτήτων</h2>
                            </div>
							
							<!-- HTML φόρμα εισαγωγής των στοιχείων δραστηριότητας -->
							<?php
								$conn = Connect();
								$strSQL = " SELECT 		scat_cat_id, cat_name, scat_id, scat_name, 
														scat_sorter, scat_active
											FROM 		extreme_events.sub_categories INNER JOIN categories 
														ON sub_categories.scat_cat_id = categories.cat_id
											ORDER BY 	categories.cat_id, scat_sorter";
								...
								if ($result)
								{
									...
									while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
									{
										...
										echo "    </td>";
										echo "    <td id=\"DataArea\" style=\"width: 20%; vertical-align: bottom;\">";
										echoX ("       <p class=\"DataCaption\">" . $cat_name . "</p>", $cat_name);
										echo "    </td>";
										echo "    <td id=\"DataArea\" style=\"width: 20%;\">";
										echoX ("       <p class=\"DataCaption\">" . $scat_name . "</p>", $scat_name);
										echo "    </td>";
										echo "    <td id=\"DataArea\" style=\"width: 10%\">";
										echoX ("       <p class=\"DataCaption\">" . $scat_sorter . "</p>", $scat_sorter);
										echo "    </td>";
										echo "    <td>";										
										echo "<a href=\"editsubcat.php?id=$scat_id\" class=\"CommandText\">Επεξεργασία</a>";
										if ($scat_active == 1)
											echo "<a href=\"activatesubcat.php?id=$scat_id&action=0\" class=\"CommandText\">Απενεργοποίηση</a>";
										if ($scat_active == 0)
											echo "<a href=\"activatesubcat.php?id=$scat_id&action=1\" class=\"CommandText\">Ενεργοποίηση</a>";
										echo "    </td>";
										echo "</tr>";
									}
									echo "</table>";
